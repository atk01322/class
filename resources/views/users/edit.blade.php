            ...
            <form method="POST" action="/users/mypage">
                ...
                <div class="form-group">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <label for="age" class="text-md-left samazon-edit-user-info-label">年齢</label>

                        <span onclick="switchEditUserInfo('.userAge', '.editUserAge', 'userAgeEditLabel');" class="userPhoneEditLabel user-edit-label">
                    ...
                    <div class="collapse show userAge">

                        <h1 class="samazon-edit-user-info-value">{{ $user->age }}</h1>

                    </div>

                    <div class="collapse editUserAge">

                        <input id="phone" type="text" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ $user->age }}" required autocomplete="age" autofocus placeholder="XX">
