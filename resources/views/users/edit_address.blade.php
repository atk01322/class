        ...
        <div class="col-md-5">
            ...
            <form method="POST" action="/users/mypage">
                ...
                <div class="form-group row">
                    ...
                    <label for="email" class="col-md-5 col-form-label text-md-left">年齢<span class="ml-1 samazon-require-input-label"><span class="samazon-require-input-label-text">必須</span></span></label>


                    <div class="col-md-7">

                        <input id="age" type="age" class="form-control @error('age') is-invalid @enderror samazon-login-input" name="age" value="{{ $user->age }}" required autocomplete="age" placeholder="XX">
